        ...
        <div className="footer-content">
            <div className="footer-content-left">
                ...
                <div className="footer-social-icons">
                    <a href="https://www.instagram.com/navin_netha_156/" target="_blank" ><img src={assets.facebook_icon} alt="" /></a>
                    ...
                    <a href="https://www.linkedin.com/in/nethaji-ravi/" target="_blank" ><img src={assets.linkedin_icon} alt="" /></a>
                </div>
            </div>
